...
import 'package:nodelabs_case/presentation/viewmodels/login_viewmodel/login_viewmodel.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: ButtonUtils().textButton(text: context.loc.forgotPass, onTap: () {}, underline: true),
                          ),
                          SizedBox(
                            height: context.height * 0.025,
                          ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(context.loc.dontHaveAccount, style: TextStyleUtils.generalText(fontSize: 13, fontWeight: FontWeight.w400, color: AppColors.opacityTextColor)),
